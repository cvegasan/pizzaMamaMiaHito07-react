            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto mb-2 mb-lg-0">
                        {!token &&
                            <Nav.Item className="cls-item-spacing">
                                <Link to="/pizzaMamaMiaHito07-react">
                        ...
                        {!token &&
                            <Nav.Item className="cls-item-spacing">
                                <Link to="/pizzaMamaMiaHito07-react/login">
                        ...
                        {!token &&
                        <Nav.Item className="cls-item-spacing">
                            <Link to="/pizzaMamaMiaHito07-react/register">
                        ...
                        {token &&
                                (<Nav.Item>
                                    <Link to="/pizzaMamaMiaHito07-react/profile">
                    ...
                    <div className="d-flex">
                        <Link to="/pizzaMamaMiaHito07-react/cart">
