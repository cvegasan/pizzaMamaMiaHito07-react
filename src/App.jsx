  ...
  return (
    ...
    <CartProvider>
      <BrowserRouter>
            <NavBar></NavBar>
              <Routes>
                <Route path="/pizzaMamaMiaHito07-react" element={<Home/>} />
                {/* si token es TRUE Login y Register-->enviar al HOME*/}
                <Route path="/pizzaMamaMiaHito07-react/register" element={token?<Home/>:<Register/>} />
                <Route path="/pizzaMamaMiaHito07-react/login" element={token?<Home/>:<Login/>} />
                {/* si token es FALSE profile --> enviar a Login*/}
                <Route path="/pizzaMamaMiaHito07-react/profile" element={token? <Profile/>:<Login/>} />
                <Route path="/pizzaMamaMiaHito07-react/cart" element={<Cart/>} />

                <Route path='/pizzaMamaMiaHito07-react/404' element={<NotFound/>} />
                <Route path='*' element={<Navigate replace to='/pizzaMamaMiaHito07-react/404'/>} />

                <Route path="/pizzaMamaMiaHito07-react/pizza/:id" element={<Pizza/>} />
              </Routes>
            <Footer></Footer>
      </BrowserRouter>
    </CartProvider>
